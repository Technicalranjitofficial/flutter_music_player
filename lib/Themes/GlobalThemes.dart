...
class GlobalThemes {
  var colors = {
    ...
    "BgCOlorWhite": Color.fromARGB(255, 7, 7, 7),
    "SeekBarColor": Color.fromARGB(255, 7, 7, 7),
    "SeekBarBaseColor": Color.fromARGB(255, 7, 7, 7),
    "SeekBarHandler": Color.fromARGB(255, 252, 252, 252),
    "BtnPlay": Color.fromARGB(255, 48, 49, 48),
    "BtnPlayIcon": Color.fromARGB(255, 113, 114, 113),
    "IconBtn": Colors.grey.shade700,
    "btnColor": Color.fromARGB(255, 7, 7, 7),
    "boxShadowWhite": Color.fromARGB(255, 141, 135, 135),
    "boxShadowDark": Color.fromARGB(255, 21, 20, 20),
  ...
  var colors2 = {
    "bgColor": Color.fromARGB(255, 49, 48, 48),
    "SeekBarColor": Colors.grey.shade800,
    "SeekBarBaseColor": Color.fromARGB(255, 49, 48, 48),
    "SeekBarHandler": Color.fromARGB(255, 172, 170, 170),
    "SeekBarHandlerCircular": Color.fromARGB(255, 101, 98, 98),
  ...
  var colors3 = {
    "bgColor": Color.fromARGB(255, 9, 89, 90),
    "SeekBarColor": Colors.grey.shade800,
    "SeekBarBaseColor": Color.fromARGB(255, 49, 48, 48),
    "SeekBarHandler": Color.fromARGB(255, 172, 170, 170),
    "SeekBarHandlerCircular": Color.fromARGB(255, 101, 98, 98),
    "BtnPlay": Colors.cyan.shade900,
    "IconBtn": Color.fromARGB(255, 172, 169, 169),
    "btnColor": Color.fromARGB(255, 49, 48, 48),
    "BtnPlayIcon": Color.fromARGB(255, 172, 169, 169),
    "boxShadowWhite": Color.fromARGB(255, 200, 195, 195),
    "boxShadowDark": Color.fromARGB(255, 60, 57, 57),
    "textColor2": Colors.grey.shade500,
