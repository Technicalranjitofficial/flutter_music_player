...
class BottomPlayContainer2 extends StatefulWidget {
  BottomPlayContainer2({super.key});

  @override
  State<BottomPlayContainer2> createState() => _BottomPlayContainerState();
}

class _BottomPlayContainerState extends State<BottomPlayContainer2> {
