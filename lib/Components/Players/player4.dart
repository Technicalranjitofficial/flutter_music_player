...
import 'package:audio_player/Components/Players/Progressbar4.dart';
...
class Player4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print("Player 2");
    return Scaffold(
      backgroundColor: globalThemes.colors3['bgColor'],
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: globalThemes.colors3['bgColor'],
                ),
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      btnShuffle(
                          globalThemes.colors3['btnColor'],
                          globalThemes.colors3['IconBtn'],
                          globalThemes.colors3['boxShadowWhite'],
                          globalThemes.colors3['boxShadowDark'],
                          globalThemes.btnGradient1),
                      Spacer(),
                      Text(
                        "Playing Now",
                        style: TextStyle(
                            ...
                            fontSize: 25,
                            color: globalThemes.colors3['textColor1']),
                      ),
                      Spacer(),
                      BtnMenu(
                          Icons.menu,
                          ...
                          globalThemes.colors3['boxShadowWhite'],
                          globalThemes.colors3['boxShadowDark'],
                          globalThemes.colors3['textColor2'],
                          globalThemes.btnGradient1)
                    ],
                  ),
                ),
              ...
              circleView(
                context,
                globalThemes.colors3['bgColor'],
                globalThemes.colors3['boxShadowWhite'],
                globalThemes.colors3['boxShadowDark'],
                globalThemes.PlayerTheme,
                globalThemes.colors3['playerThemesColor'],
              ),
              // Songs title
              Spacer(),
              SongsInfo(globalThemes.colors3['textColor2']),
              Spacer(),

              //Seekbar
              // seekbar(
              //   globalThemes.colors3['SeekBarBaseColor'],
              //   globalThemes.colors3['SeekBarColor'],
              //   globalThemes.colors3['SeekBarHandler'],
              //   globalThemes.colors3['boxShadowWhite'],
              //   globalThemes.colors3['boxShadowDark'],
              // ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    btnplay(
                      context,
                      globalThemes.colors3['BtnPlay'],
                      globalThemes.colors3['boxShadowWhite'],
                      globalThemes.colors3['boxShadowDark'],
                      globalThemes.colors3['BtnPlayIcon'],
                    ),
                    ...
                    builder: (context, value, child) {
                      return TextScroll(
                        ...
                        style: TextStyle(
                          ...
                          color: globalThemes.colors3['textColor2'],
                          fontSize: 20,
                        ),
                      );
                    },
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient:
                LinearGradient(colors: [Colors.teal, Colors.cyan, Colors.pink]),
          ),
        ),
        Container(
          height: 300,
...
Widget BtnMenu(IconData icon, bgColor, IconBtn, shadowWhite, shadowBlack,
    textColor2, gradient) {
  return Container(
    decoration: BoxDecoration(
      color: bgColor,
...
Widget btnShuffle(bgColor, IconBtn, shadowWhite, shadowBlack, gradient) {
  return Container(
    decoration: BoxDecoration(
        color: bgColor,
        shape: BoxShape.circle,
...
Widget btnnext(BuildContext context, IconData icon, bgColor, IconBtn,
    shadowWhite, shadowBlack, gradient) {
  return Container(
      decoration: BoxDecoration(
          color: bgColor,
          shape: BoxShape.circle,
